  ...
  <body>
    ...
    <div id="main-content">
      ...
      <form action="" method="post">
        ...
        <div class="entry">
          <label for="length_value_from">From:</label>&nbsp;
          <input type="text" id="length_value_from" name="from_value" value="<?php echo $from_value; ?>" />&nbsp;
        ...
        <div class="entry">
          <label for="length_value_to">To:</label>&nbsp;
          <input type="text" id="length_value_to" name="to_value" value="<?php echo float_to_string($to_value); ?>" />&nbsp;
          <select name="to_unit">
